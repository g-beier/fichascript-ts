...
<template>
  <Popover v-slot="{ open }" class="relative">
    <PopoverButton
      ...
      class="flex w-full flex-col items-center rounded-md border border-gray-400 bg-white px-3 py-2 text-gray-500 hover:bg-red-100 focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50 focus-visible:outline-none"
    >
